...
const Banner: React.FC = () => (
    <div className="flex flex-wrap items-center justify-center w-full h-[40px] sm:h-[44px] px-3 sm:px-4 font-medium text-xs sm:text-sm text-white text-center bg-gradient-to-b from-orange-500 to-orange-600 gap-2 sm:gap-3">
