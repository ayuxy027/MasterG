...
const PromptInput: React.FC<PromptInputProps> = ({ 
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-xl border-2 border-orange-100">
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Describe Your Poster</h3>
      ...
      <div className="mb-4">
        <textarea
          ...
          className="w-full border-2 border-orange-200 rounded-xl p-4 resize-none h-32 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all"
          maxLength={500}
        />
