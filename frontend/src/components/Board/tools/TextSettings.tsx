            ...
            {colors.map((colorOption) => (
              <button
                ...
                className={`w-6 h-6 rounded-full border ${
                  color === colorOption ? "border-gray-700" : "border-gray-200"
                }`}
                style={{
                  backgroundColor:
                    colorOption === "transparent" ? "white" : colorOption,
                  backgroundImage:
                    colorOption === "transparent"
                      ? "repeating-linear-gradient(45deg, #ccc 0, #ccc 1px, transparent 1px, transparent 4px), repeating-linear-gradient(-45deg, #ccc 0, #ccc 1px, transparent 1px, transparent 4px)"
                      : "none",
                }}
                onClick={() => onUpdate(id, { color: colorOption })}
                title={
                  colorOption === "transparent" ? "Transparent" : colorOption
                }
              />
            ))}
          </div>
