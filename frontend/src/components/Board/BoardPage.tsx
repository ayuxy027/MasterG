...
const BoardPage: React.FC = () => {
  ...
  const handleGenerateCards = useCallback(async (prompt: string, count: number = 3) => {
    ...
    try {
      const newCards = await generateCards(prompt, count);
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-orange-50 via-white to-orange-50/30">
      ...
      <div className="fixed top-4 right-4 z-50">
        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg shadow-lg backdrop-blur-sm border transition-all ${ollamaStatus.connected
