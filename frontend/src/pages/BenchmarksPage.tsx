...
const Badge = ({ label, variant = 'default' }: { label: string; variant?: BadgeVariant }) => (
  <span className={`inline-flex items-center px-3 py-1 rounded-lg text-xs font-medium ${BADGE_VARIANTS[variant]}`}>
