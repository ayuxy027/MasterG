...
export class ChunkingService {
  ...
  async createChunks(
    ...
    try {
      ...
      console.log(`📝 Page ${pageNumber} detected as ${languageDetection.language} (${languageDetection.languageCode}) with ${(languageDetection.confidence * 100).toFixed(0)}% confidence`);
      ...
      console.log(`✅ Created 1 chunk for ${fileName} (Page ${pageNumber}, Lang: ${languageDetection.language})`);
