  ...
  async uploadFile(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (file.mimetype === SUPPORTED_FILE_TYPES.PDF) {
        ...
        console.log(`📄 Extracted ${pages.length} pages from ${file.originalname}`);
        ...
        console.log(`🌐 Detected document language: ${documentLanguageDetection.language} (${documentLanguageDetection.languageCode})`);
